...
wget https://github.com/AnkanSaha/ContainDB/releases/download/v4.11.17-stable/containDB_4.11.17-stable_amd64.deb

# install the package
sudo dpkg -i containDB_4.11.17-stable_amd64.deb
```
