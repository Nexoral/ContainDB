...
wget https://github.com/AnkanSaha/ContainDB/releases/download/v3.10.15-stable/containDB_3.10.15-stable_amd64.deb

# install the package
sudo dpkg -i containDB_3.10.15-stable_amd64.deb
```
