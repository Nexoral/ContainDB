...
wget https://github.com/AnkanSaha/ContainDB/releases/download/v5.12.21-stable/containDB_5.12.21-stable_amd64.deb

# Install the package
sudo dpkg -i containDB_5.12.21-stable_amd64.deb
```
