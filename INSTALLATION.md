...
wget https://github.com/Nexoral/ContainDB/releases/download/v5.14.32-stable/containDB_5.14.32-stable_amd64.deb

# Install the package
sudo dpkg -i containDB_5.14.32-stable_amd64.deb
