...
wget https://github.com/nexoral/ContainDB/releases/download/v5.14.33-stable/containDB_5.14.33-stable_amd64.deb

# Install the package
sudo dpkg -i containDB_5.14.33-stable_amd64.deb
